...
// A. Logika Tambah User dengan Validasi Gmail
if (isset($_POST['tambah_user'])) {
    $u = mysqli_real_escape_string($conn, $_POST['username']);
    $p = mysqli_real_escape_string($conn, $_POST['password']);
    
    // VALIDASI: Cek apakah mengandung @gmail.com
...
// B. Logika Lainnya (Hapus & Update) tetap sama
...
$sql = $view_all ? "SELECT * FROM login ORDER BY id DESC" : "SELECT * FROM login ORDER BY id DESC LIMIT $start, $limit";
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul>
            <li><a href="Dashboard.php" class="active"><i class='bx bxs-grid-alt'></i> Dashboard</a></li>
            ...
            <form method="POST" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; align-items: end;">
                <div>
                    ...
                    <input type="email" name="username" placeholder="contoh@gmail.com" required 
                           pattern=".+@gmail\.com" title="Harus menggunakan domain @gmail.com">
                </div>
                <div>
        ...
        <div class="card">
            <form method="POST">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; flex-wrap: wrap; gap: 20px;">
                    <input type="text" id="liveSearch" placeholder="Cari admin..." onkeyup="searchTable()" style="width: 300px;">
    ...
    <p>
        &copy;</span> Candra Argadinata, S.Kom. 2026.
    </p>
</footer>
</body>
</html>