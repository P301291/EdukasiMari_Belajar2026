      ...
      <aside class="dashboard-sidebar" id="dashboardSidebar">
        ...
        <div class="sidebar-footer">
          <a href="#" class="btn btn-secondary sidebar-back-button">
            ...
            <span class="btn-label">MARI BELAJAR</span>
          </a>
        </div>
      </aside>
            ...
            <div class="user-menu" id="userMenu">
              <div class="user-menu-trigger" id="user-menu-trigger">
                <div class="user-avatar-small">
                  <img src="gambar/mb21.png" alt="User Avatar" />
                </div>
              </div>
        ...
        <div class="dashboard-content">
            ...
            <div class="stats-grid">
              <div class="stat-card">
                <div class="stat-card-header">
                  <div class="stat-card-title">Pendaftar</div>
              ...
              <div class="stat-card">
                <div class="stat-card-header">
                  <div class="stat-card-title">Laki-Laki</div>
              ...
              <div class="stat-card">
                <div class="stat-card-header">
                  <div class="stat-card-title">Perempuan</div>
              ...
              <div class="stat-card">
                <div class="stat-card-header">
                  <div class="stat-card-title">Semua Peserta</div>
          ...
          <div class="dashboard-view" id="projects">
            <div class="empty-state">
              ...
              <h3 class="empty-state-title">Projects aku</h3>
